local function callback()
  return {
    ...
    ["@text.title.1.markdown"] = { fg = C.purple, bold = true },
    ["@text.title.2.markdown"] = { fg = C.blue, bold = true },
    ["@text.title.3.markdown"] = { fg = C.cyan, bold = true },
    ["@text.title.4.markdown"] = { fg = C.green, bold = true },
    ["@text.title.5.markdown"] = { fg = C.yellow, bold = true },
