C = {}
local util = require "mctheme.lib.util"
...
function M.load(theme)
  ...
  local highlights = {}
  highlights = util.get_hl_modules(highlights, "mctheme.groups", {
    "base",
    "syntax",
    "lsp",
    "astronvim",
  ...
  highlights = util.get_hl_modules(highlights, "mctheme.groups.plugins", M.config.plugins)
...
function M.setup(opts)
  M.config = require("mctheme.lib.config").user_config(opts)
